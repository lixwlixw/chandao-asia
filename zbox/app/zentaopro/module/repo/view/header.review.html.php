...
$blamePairs  = array();
if($suffix != 'binary' and strpos($this->config->repo->images, "|$suffix|") === false)
{
...
<div class="bugFormContainer">
  <table class='table table-form'>
    <tr><th><?php echo $lang->repo->product?></th>
<td style="width:45%">
...
<th><?php echo $lang->repo->module?></th><td><?php echo $moduleSelect?></td></tr>
